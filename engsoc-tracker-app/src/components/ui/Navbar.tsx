...
export function Navbar() {
    return (
        <header className="sticky top-0 z-20 flex items-center justify-between border-b px-6 py-4 bg-background select-none">
            <div className="flex items-center gap-4">
                <img
                    ...
                    className="h-12 w-12"
                />
                <h2 className="text-lg font-semibold">Engineering Application Tracker</h2>
            </div>
            <SettingsModal />
        </header>
    )
